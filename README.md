...
A production-ready Laravel Eloquent learning repository.

## 📚 Lessons

| Lesson | Topic | Status |
|---------|-------|--------|
| 01 | [Database → SQL → ORM → Eloquent](./lessons/lesson-01-database-sql-orm-eloquent/README.md) | ✅ |
| 02 | [Model Basics & Naming Conventions](./lessons/lesson-02-model-basics/README.md) | ✅ |
...
| 10 | [Laravel Hack #06 — paginate() vs simplePaginate() vs cursorPaginate()](./lessons/lesson-laravel-note-pagination-simplePagiantion-cursorPagination/README.md) | ✅ |
| 12 | Relationships  | ⏳ |
| 13 | Eager Loading | ⏳ |
| 14 | Aggregates | ⏳ |
| 15 | Query Scopes | ⏳ |